...
class TXCM(nn.Module):
    def __init__(self, window_size, time_length, feature_length, n_classes):
        ...
        self.cnn_layers3 = nn.Sequential(
            OrderedDict(
                [
                    ...
                    ("batchnorm_31", nn.BatchNorm2d(16)),
        ...
        self.avgpool_layer = nn.Sequential(
            OrderedDict([("avgpool", nn.AvgPool2d((1, time_length)))])
        )
        ...
        self.linear_layers = nn.Sequential(
            OrderedDict(
                [
                    ("flatten", nn.Flatten()),
                    ("fc1", nn.Linear(feature_length * 16, n_classes)),
    ...
    def forward(self, x):
        ...
        main_branch = self.cnn_layers3(main_branch.unsqueeze(1))
